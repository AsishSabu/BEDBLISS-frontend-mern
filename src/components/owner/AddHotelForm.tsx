      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-4 flex flex-row ">
          <div className="flex-1 flex flex-col gap-4 ">
            ...
            {placeError && <p className="text-red-500 text-center">{placeError}</p>}
            ...
            {descriptionError && <p className="text-red-500 text-center">{descriptionError}</p>}
            ...
            {aboutPropertyError && <p className="text-red-500 text-center">{aboutPropertyError}</p>}

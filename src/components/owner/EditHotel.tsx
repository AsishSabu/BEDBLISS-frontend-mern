          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4 flex flex-row ">
              <div className="flex-1 flex flex-col gap-4 ">
                ...
                {error.placeError && (
                  <p className="text-red-500">{error.placeError}</p>
                )}
                ...
                {error.descriptionError && (
                  <p className="text-red-500">{error.descriptionError}</p>
                )}
                <div className=" flex gap-3">
                  <label className="text-gray-700 text-lg font-bold mb-2 flex items-center">
                    About Property:
                ...
                {error.aboutPropertyError && (
                  <p className="text-red-500">{error.aboutPropertyError}</p>
                )}
                <div className="mb-4 ">
                  <label className="text-gray-700 text-lg font-bold mb-2 flex items-center">
                    Property Rules:
                    ...
                    {formData.propertyRules.map((rule, index) => (
                      <div key={index} className="mb-2">
                        <input
                          ...
                          value={rule}
                          onChange={e =>
                            handleChange(e, index, "propertyRules")
                          }
                        />
                      </div>
                    ))}
                ...
                {error.propertyRulesError && (
                  <p className="text-red-500">{error.propertyRulesError}</p>
                )}
              </div>
              ...
              <div className="flex flex-1 flex-col justify-center items-center gap-3 ">
                <img
                  src={
                    imagePreview ? imagePreview : "https://picsum.photos/200"
                  }
                  alt="Profile"
                ...
                {error.imageError && (
                  <p className="text-red-500">{error.imageError}</p>
                )}
              </div>
            </div>
            ...
            {error.ammenityError && (
              <p className="text-red-500">{error.ammenityError}</p>
            )}
                    ...
                    <div>
                      <div className="flex items-center gap-2 mx-5">
                        <input
                          ...
                          onChange={() =>
                            handleRoomEnabledChange(roomType.name)
                          }
                        />
